            ...
            <div>
                ...
                <form onSubmit= {this.formHandler} id="form" action="#"> {/* https://ptsv2.com/t/guayerd/post  method="POST" */}
                    ...
                    <div className="input_name">
                        ...
                        <input onChange = {this.nombreHandler} id="nombre" className="name" type="text" name="name" placeholder="(*) Escriba su nombre" maxLength={40} />{/*luis antes no estaba max caract*/}
                    </div>
                    <div className="input_email">
                        <label htmlFor="email" className="emaillabel">Email</label>
                        <input onChange = {this.emailHandler} id="email" className="email" type="text" name="email" placeholder="(*) Escriba su email" maxLength={40} /> {/*luis antes no estaba max caract*/}
                    </div>
                    ...
                    <div className="input_topic">
                        ...
                        <select onChange = {this.topicHandler} id="tema" className="select" name="topic" value="tema">
