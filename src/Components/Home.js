...
.then(imagenData=>{
    ...
    render() {
        ...
        calidad, no se admitían bicicletas fabricadas en Argentina para su reparación. <br />
        Ese menosprecio hacia los productos del país de origen de Bill Jobs le llevó a abrir, la que
        sería, la primera fábrica de Guayerd Bikes en 1972. <br />
        ...
        cumplir con tres premisas “Gu-ah-yerd”. <br />
        En 2013, GUAYERD cumplió su 25 aniversario, portando con orgullo la filosofía con la que
        Bill Jobs fundase la primera fábrica en 1972. <br />
        ...
        Argentina y China. </p>
                        <h1>Innovación</h1>
                        <p>La historia de cada bicicleta GUAYERD empieza sólo a 100km del lugar donde la historia de
        ...
        planifican y desarrollan para su distribución internacional en 77 países. <br />
        ...
        I+D alemán viaja frecuentemente Taiwán. <br />
        ...
        cuidado posible. </p>
                        <h1>Bicis</h1>
                        <p>GUAYERD Industry Co.,Ltd, no sólo mira atrás con su experiencia de 40 años usando
        ...
        a ver un cartel en el que se rechacen productos del país asiático por su escasa calidad. <br />
        ...
        nadie confía en nuestras bicicletas más que nosotros.</p>
                        <h1>Más Éxitos</h1>
                        <p>Durante más de una década, GUAYERD ha sido el principal patrocinador del MULTIVAN
        ...
        competir al más alto nivel tanto en MTB como en carretera. <br />
